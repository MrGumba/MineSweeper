...
def find(numbers, n): 
    ...
    return position # Returnerar vilken position i listan talet har.
...
def generateList(element, numberSpan):
    ...
    return numbers # Returnerar en listan med slumpmessiga tal som används som listan för det sökta talet.
